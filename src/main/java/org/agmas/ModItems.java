...
public class ModItems {
    ...
    public static final Item ICE_SMITHING_TEMPLATE = register("ice_smithing_template",Item::new, new Item.Properties());
    ...
    public static final Item MINED_SMITHING_TEMPLATE = register("mined_smithing_template",Item::new, new Item.Properties());
    public static final Item HOLIDAY_SMITHING_TEMPLATE = register("holiday_smithing_template",Item::new, new Item.Properties());
    public static final Item GUI_SMITHING_TEMPLATE = register("gui_smithing_template",Item::new, new Item.Properties());
    ...
    public static final Item HYPERDEATH_SMITHING_TEMPLATE = register("hyperdeath_smithing_template",Item::new, new Item.Properties());
    ...
    public static final Item NOSTALGIA_SMITHING_TEMPLATE = register("nostalgia_smithing_template",Item::new, new Item.Properties());
    ...
    public static final Item RUNESCAPE_SMITHING_TEMPLATE = register("runescape_smithing_template",Item::new, new Item.Properties());
    public static final Item SENTINAL_SMITHING_TEMPLATE = register("sentinal_smithing_template",Item::new, new Item.Properties());
    public static final Item SHIPPED_SMITHING_TEMPLATE = register("shipped_smithing_template",Item::new, new Item.Properties());
    public static final Item SHRIMP_SMITHING_TEMPLATE = register("shrimp_smithing_template",Item::new, new Item.Properties());
    public static final Item SPECIALOPS_SMITHING_TEMPLATE = register("specialops_smithing_template",Item::new, new Item.Properties());
    public static final Item VIRTUE_SMITHING_TEMPLATE = register("virtue_smithing_template",Item::new, new Item.Properties());
